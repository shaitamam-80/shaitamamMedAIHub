...
#### 1. Trial Period
- [x] כמה ימים? **7 ימים** למשתמשים מזדמנים
- [x] משתתפי סדנא: **3 חודשים** גישה

#### 2. תמחור
- [x] מטבע: **שקלים (₪)**
- [x] מנוי: **חודשי**
- [ ] מחיר חודשי: **לקבוע** (הצעה: ₪49-79)

#### 3. הגבלות לפי Tier
- [ ] **להחליט מאוחר יותר** - אילו חלקים באתר מוגבלים

#### 4. שפה
- [ ] Admin Dashboard: **לקבוע**
- [ ] Emails: **לקבוע**

### Tier Structure מעודכן
...
├─────────────────────────────────────────────────────────────────┤
│                                                                  │
│  SUPER_ADMIN ─── אתה, גישה מלאה                                 │
│       │                                                          │
│  ADMIN ───────── מנהלים נוספים (אופציונלי)                      │
│       │                                                          │
│  PRO ─────────── מנוי חודשי בתשלום (₪)                          │
│       │                                                          │
│  WORKSHOP ────── משתתפי סדנא (3 חודשים)    ← NEW!               │
│       │                                                          │
│  FREE ────────── Trial 7 ימים                                   │
│                                                                  │
└─────────────────────────────────────────────────────────────────┘
