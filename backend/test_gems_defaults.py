...
def main():
    ...
    if quick_defaults['screening'].get('generate_synthesis'):
        print(f'  AI Synthesis: Enabled')
        print(f'  Max articles for synthesis: {quick_defaults["screening"]["max_articles_for_synthesis"]}')
