...
SYSTEMATIC_REVIEW_DEFAULTS: dict[str, Any] = {
    ...
    "intervention": {"must_appear_in_abstract": True, "exclude_surgical": False},
    "comparator": {
        "required": True,
...
SCOPING_REVIEW_DEFAULTS: dict[str, Any] = {
    ...
    "population": {"age_groups": ["all"], "sex": "all", "special_conditions": [], "exclusions": []},
    "intervention": {
...
QUICK_ANSWER_DEFAULTS: dict[str, Any] = {
    ...
    "intervention": {"must_appear_in_abstract": True, "exclude_surgical": False},
    "comparator": {"required": False, "type": None},
    "outcome": {
        "requires_quantitative": False,
        "accepts_qualitative": False,
        "minimum_followup": None,
