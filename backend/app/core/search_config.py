...
DRUG_CLASS_EXPANSIONS = {
    ...
    "serotonin uptake inhibitors": ["Fluoxetine", "Paroxetine", "Sertraline", "Citalopram", "Escitalopram", "Fluvoxamine"],
    "selective serotonin reuptake inhibitor": ["Fluoxetine", "Paroxetine", "Sertraline", "Citalopram", "Escitalopram", "Fluvoxamine"],
    ...
    "tricyclic antidepressant": ["Amitriptyline", "Nortriptyline", "Imipramine", "Desipramine", "Clomipramine", "Doxepin"],

    # Benzodiazepines
    "benzodiazepine": ["Diazepam", "Lorazepam", "Alprazolam", "Clonazepam", "Oxazepam", "Chlordiazepoxide"],
    "benzodiazepines": ["Diazepam", "Lorazepam", "Alprazolam", "Clonazepam", "Oxazepam", "Chlordiazepoxide"],

    # Atypical Antipsychotics
    "atypical antipsychotic": ["Risperidone", "Olanzapine", "Quetiapine", "Aripiprazole", "Ziprasidone", "Clozapine"],
    ...
    # ACE Inhibitors
    "ace inhibitor": ["Lisinopril", "Enalapril", "Ramipril", "Captopril", "Benazepril", "Perindopril"],
    "ace inhibitors": ["Lisinopril", "Enalapril", "Ramipril", "Captopril", "Benazepril", "Perindopril"],
    ...
    "proton pump inhibitor": ["Omeprazole", "Esomeprazole", "Pantoprazole", "Lansoprazole", "Rabeprazole"],
}
